...
?>
                    ...
                    <div class="same-height-row">
                        <div class="col-sm-4">
                            <div class="box same-height clickable">
                                <div class="icon"><i class="fa fa-star-half-empty"></i>
                                </div>

                                <h2><a href="#" class="text-uppercase">โรงแรม</a></h2>
                                <a class="listtext" href="#"><strong>Bangkok</strong></a>
                                    <ul>
                                        <li class="list-group-item-danger list-unstyled"><a class="listtext superspace_light" href="#">4 Stars</a></li>
                                        <li class="list-group-item-danger list-unstyled"><a class="listtext" href="#">5 Stars</a></li>
                                    </ul>
                                <a class="listtext" href="#"><strong>Pattaya</strong></a>
                                    <ul>
                                        <li class="list-group-item-danger list-unstyled"><a class="listtext" href="#">4 Stars</a></li>
                                        <li class="list-group-item-danger list-unstyled"><a class="listtext" href="#">5 Stars</a></li>
                                    </ul>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <div class="box same-height clickable">
                                ...
                                <h2><a href="#" class="text-uppercase superspace">สถานที่ท่องเที่ยว</a></h2>
                        ...
                        <div class="col-sm-4">
                            <div class="box same-height clickable">
                                ...
                                <h2><a href="#" class="text-uppercase superspace">ข่าวสาร และโปรโมชั่น</a></h2>
            ...
            <div class="box text-center" data-animate="fadeInUp">
                <div class="container">
                    <div class="col-md-12">
                        ...
                        <p class="read-more">
                            <a href="about.php" class="btn btn-primary">อ่านต่อ</a>
                        </p>
                    </div>
                </div>
            </div>
 ...
 _________________________________________________________ -->
            <!--<div id="hot">
                ...
                <div class="box">
                    <div class="container">
                        <div class="col-md-12">
                            <h2 class="text-uppercase text-primary superspacebold">Hot this week</h2>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="item">
                            <div class="product">
                                ...
                                <div class="text">
                                    ...
                                    <p class="price superspace">$143.00</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="item">
                            <div class="product">
                                ...
                                <div class="text">
                                    ...
                                    <p class="price superspace"><del>$280</del> $143.00</p>
                                </div>
 ...
 _________________________________________________________ -->
            ...
            <div class="box text-center" data-animate="fadeInUp">
                <div class="container">
                    <div class="col-md-12">
                        <h3 class="text-uppercase text-primary superspacebold"><?php echo $recommendtitle; ?></h3>
            ...
            <div class="container">
                ...
                <div class="col-md-12" data-animate="fadeInUp">
                    ...
                    <div id="blog-homepage" class="row">
                        <div class="col-sm-6">
                            <div class="post">
                                <h4><a href="post.php">Blog 1</a></h4>
                                <p class="author-category">By <a href="#">John Slim</a> in <a href="">Blog 1</a>
                                </p>
                                <hr>
                        ...
                        <div class="col-sm-6">
                            <div class="post">
                                <h4><a href="post.php">Blog 2</a></h4>
                                <p class="author-category">By <a href="#">John Slim</a> in <a href="">Blog 2</a>
                                </p>
                                <hr>
                                <p class="intro">Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean
                                    ultricies mi vitae est. Mauris placerat eleifend leo.</p>
