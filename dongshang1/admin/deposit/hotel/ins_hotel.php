...
<body>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <h2 class="header">เพิ่มรายละเอียดโรงแรม</h2>
        <form class="well form-horizontal" action="ins_hotelchk.php" method="post"  id="contact_form">
          <fieldset>
          ...
          <div class="form-group">
            ...
            <div class="col-md-4 inputGroupContainer">
              <div class="input-group">
                ...
                <input name="hotel_name" placeholder="Ex. Avana Hotel" class="form-control"  type="text">
              </div>
            </div>
          </div>
