  ...
  <nav class="navbar navbar-inverse navbar-fixed-top">
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <h2 class="header">แก้ไขรายละเอียดกอล์ฟ</h2>
        <form class="well form-horizontal" action="edit_golfchk.php?id=<?php echo $rs['id']; ?>" method="post"  id="contact_form">
          <fieldset>
          ...
          <div class="form-group">
            ...
            <div class="col-md-4 inputGroupContainer">
              <div class="input-group">
                ...
                <input name="golf_name" placeholder="Ex. Avana Hotel" class="form-control"  type="text" value="<?php echo $rs['golf_name']; ?>">
              </div>
            </div>
          </div>
