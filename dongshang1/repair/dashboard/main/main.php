...
if(isset($_POST['save_card'])){
	if(htmlspecialchars($_POST['card_customer_name'])!= NULL && htmlspecialchars($_POST['card_customer_phone']) != NULL ){
		$card_key=md5(htmlspecialchars($_POST['card_customer_name']).htmlspecialchars($_POST['card_code']).time("now"));
		$getdata->my_sql_insert("card_info","card_key='".$card_key."',card_code='".htmlspecialchars($_POST['card_code'])."',card_customer_name='".htmlspecialchars($_POST['card_customer_name'])."',card_customer_lastname='".htmlspecialchars($_POST['card_customer_lastname'])."',card_customer_address='".htmlspecialchars($_POST['card_customer_address'])."',card_customer_phone='".htmlspecialchars($_POST['card_customer_phone'])."',card_customer_email='".htmlspecialchars($_POST['card_customer_email'])."',card_note='".htmlspecialchars($_POST['card_note'])."',card_done_aprox='0000-00-00',user_key='".$user_data->user_key."',card_status=''");
...
<nav class="navbar navbar-default">
  ...
  <tbody>
  <?php
  if(htmlspecialchars($_GET['type']) != NULL){
	   $getcard = $getdata->my_sql_select(NULL,"card_info","card_status = '".htmlspecialchars($_GET['type'])."' ORDER BY card_insert");
  }else{
