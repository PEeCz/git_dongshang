...
if(isset($_POST['save_card'])){
	if(htmlentities($_POST['card_customer_name'])!= NULL && htmlentities($_POST['card_customer_phone']) != NULL ){
		...
		$getdata->my_sql_insert("card_info","card_key='".$card_key."',card_code='".addslashes(htmlentities($_POST['card_code']))."',card_customer_name='".addslashes(htmlentities($_POST['card_customer_name']))."',card_customer_lastname='".addslashes(htmlentities($_POST['card_customer_lastname']))."',card_customer_address='".addslashes(htmlentities($_POST['card_customer_address']))."',card_customer_phone='".addslashes(htmlentities($_POST['card_customer_phone']))."',card_customer_email='".addslashes(htmlentities($_POST['card_customer_email']))."',card_note='".addslashes(htmlentities($_POST['card_note']))."'");
