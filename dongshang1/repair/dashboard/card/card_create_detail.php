...
if(htmlspecialchars($_GET['key']) == NULL){
	...
	$card_detail = $getdata->my_sql_query(NULL,"card_info","card_key='".htmlspecialchars($_GET['key'])."'");
	updateDateNow();
}
?>
<div class="row">
...
if(isset($_POST['save_item'])){
	if(htmlspecialchars($_POST['item_name']) != NULL && htmlspecialchars($_POST['item_note']) != NULL){
		$item_key = md5(htmlspecialchars($_POST['item_name']).time("now").rand());
		if(htmlspecialchars($_POST['item_price_aprox']) != NULL){
			$price_aprox = htmlspecialchars($_POST['item_price_aprox']);
		}else{
			$price_aprox=0;
		}
		
		
		$getdata->my_sql_insert("card_item","item_key='".$item_key."',card_key='".$card_detail->card_key."',item_number='".INumber()."',item_name='".addslashes(htmlspecialchars($_POST['item_name']))."',item_note='".addslashes(htmlspecialchars($_POST['item_note']))."',item_price_aprox='".@$price_aprox."'");
		updateItem();
...
if(isset($_POST['save_edit_item'])){
	if(htmlspecialchars($_POST['edit_item_name']) != NULL && htmlspecialchars($_POST['edit_item_note']) != NULL){
		$getdata->my_sql_update("card_item","item_name='".htmlspecialchars($_POST['edit_item_name'])."',item_note='".htmlspecialchars($_POST['edit_item_note'])."',item_price_aprox='".@htmlspecialchars($_POST['edit_item_price_aprox'])."'","item_key='".htmlspecialchars($_POST['item_key'])."'");
...
if(isset($_POST['save_confirm_card'])){
	...
	$getdata->my_sql_update("card_info","card_done_aprox='".@$card_done_aprox."',card_status='".htmlspecialchars($_REQUEST['card_status'])."',user_key='".$userdata->user_key."'","card_key='".$card_detail->card_key."'");
	$cstatus_key=md5(htmlspecialchars($_REQUEST['card_status']).rand().time("now"));
	$getdata->my_sql_insert("card_status","cstatus_key='".$cstatus_key."',card_key='".$card_detail->card_key."',card_status='".htmlspecialchars($_REQUEST['card_status'])."',card_status_note='".htmlspecialchars($_POST['card_status_note'])."',user_key='".$userdata->user_key."'");
