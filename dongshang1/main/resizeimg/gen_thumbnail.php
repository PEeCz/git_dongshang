...
function createthumb($name,$filename,$new_w,$new_h,$color_bg,$output_type,$show,$crop){
    ...
    function imgSrcBkk($link){
        echo "dist/images/bkk-samutprakarn/".$link;
    }

    function imgSrcChonburi($link){
        echo "dist/images/chonburi-pattaya/".$link;
    }

    function imgSrcHuahin($link){
        echo "dist/images/huahin-prachuab/".$link;
    }

    function imgSrcNakornnayok($link){
        echo "dist/images/nakornnayok-chacherngsao/".$link;
    }

    function imgSrcNakornpathom($link){
        echo "dist/images/nakornpathom/".$link;
    }

    function imgSrcPathumthani($link){
        echo "dist/images/pathumthani/".$link;
    }
?>