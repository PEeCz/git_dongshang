...
";	
	...
	$mpdf->WriteHTML($html);
	//$mpdf->Output();
	$mpdf->Output("CustPDF/Order-$orderno.pdf");   
	echo "<center>Download Order $orderno.pdf <a href='CustPDF/Order-$orderno.pdf'>Click Here</a></center>";

	
} else {
	echo "<center><h1>Access Denied</h1>เฉพาะลูกค้าเจ้าของ Order นี้เท่านั้นที่จะสามารถ Download ข้อมูลใบสั่งซื้อได้</center>";
}
