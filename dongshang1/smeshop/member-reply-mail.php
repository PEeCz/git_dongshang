...
mysqli_query($connection,"update ".$fix."contactus set new='1' where contactid='".$contactid."'");
...
<tr bgcolor=\"$syscolor1\"><td colspan=2 align=center><h3><i class='fa fa-edit'></i> แบบฟอร์มตอบกลับ</h3></td></tr>
<tr bgcolor=\"$syscolor1\"><td width=30%>ส่งจาก (อีเมล์ลูกค้า)</td><td><input class=\"tblogin\" type=email name=custemail size=40 value='".$arr['custemail']."'> *</td></tr>
<tr bgcolor=\"$syscolor1\"><td>ชื่อ-นามสกุล (ลูกค้า)</td><td><input class=\"tblogin\" type=text size=40 name=custname value='".$arr['custname']."'> *</td></tr>
<tr bgcolor=\"$syscolor1\"><td>ส่งถึง อีเมล์ (ร้านค้า)</td><td><input class=\"tblogin\" type=text size=40 name=email value=\"$emailcontact\" disabled></td></tr>
